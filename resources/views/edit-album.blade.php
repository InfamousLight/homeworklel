    ...
    <div class="container">
        ...
        <form method="POST" action="{{ action('AlbumController@create') }}" role="form">
            ...
            <div class="form-group">
                ...
                <input class="form-control" id="album-name" name="album-name" placeholder="Enter Band Name" value="{{$album->name}}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input class="form-control" id="number-of-tracks" name="number-of-tracks" placeholder="Enter Number of Tracks" value={{$album->number_of_tracks}}>
            </div>
            <div class="form-group">
